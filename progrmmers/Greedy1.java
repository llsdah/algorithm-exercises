...
public class Greedy1 {
	...
	public static int solution(int n, int[] lost, int[] reserve) {
        ...
        Queue<Integer> lost2 =new LinkedList<Integer>();
        Queue<Integer> reserve2 =new LinkedList<Integer>();
        ...
        while(lost2.peek()!=null&&reserve2.peek()!=null ) {
